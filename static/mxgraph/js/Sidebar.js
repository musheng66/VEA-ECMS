...
Sidebar.prototype.addGeneralPalette = function(expand)
{
  ...
  if (this.editorUi.sidebarData.generalPalette) {
    fns = []
    for (let i of this.editorUi.sidebarData.generalPalette) {
      fns.push(this.createEdgeTemplateEntry(i.style, i.width, i.height, i.value, i.title, i.showLabel, i.tags))
    }
  }
